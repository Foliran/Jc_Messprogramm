...
StartDialogMultiple::StartDialogMultiple(QWidget* parent)
    : QDialog(parent)
...
QSize StartDialogMultiple::sizeHint() const
{
    return QSize(400, 300);
}

QSize StartDialogMultiple::minimumSizeHint() const
{
    return QSize(200, 100);
}

void StartDialogMultiple::accept()
{
...
void StartDialogMultiple::setupUI()
{
    ...
    connect(logSteps, &QCheckBox::stateChanged, this, &StartDialogMultiple::adjustCurrent);
...
std::vector <std::shared_ptr<const MeasurementSequence>> StartDialogMultiple::createSequence() const
{
...
void StartDialogMultiple::adjustCurrent() {
